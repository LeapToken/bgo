...
<head>
    ...
    <title>Барбоскины: Game Over 2</title>
    <style>
        body {
...
<body>
    <header>
        ...
        <div class="button-container">
            <button class="button" onclick="redirectToCheck()">Вход</button>
            <button class="button" onclick="redirectToCheck2()">Регистрация</button>
        </div>
    </header>
    <p>
    ...
    <div id="imageButtonContainer">
        ...
        <br>
        <button class="button buy-button" onclick="redirectToCheck()">Пред-Заказ</button>
        <button class="button buy-button" onclick="redirectToCheck()">Галерея</button>
    </div>
